...
shell.run("buildroof", 5, 19, 2, 21, 0)
shell.run("buildroof", 5,  9, 2, 21, 3)
shell.run("buildroof", 5, 19, 2, 21, 5)
...
shell.run("buildroof", 5, 11, 3, 21, 0)
shell.run("buildroof", 5, 21, 3, 21, 3)
...
shell.run("buildroof", 3, 13, 6, 21, 0)
shell.run("buildroof", 3, 23, 6, 21, 3)
...
shell.run("buildroof", 3, 15, 7, 21, 0)
shell.run("buildroof", 3, 25, 7, 21, 3)
...
shell.run("buildroof", 3, 17, 8, 21, 0)
